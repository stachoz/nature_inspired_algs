...
void RealSolution::set_solution_vector(const std::vector<double>& solution_vector) {
...
RealSolution::RealSolution(const RealSolution &other) : Solution(other) { RealSolution::operator=(other); }
...
std::vector<double> RealSolution::get_solution_vector() { return solution_vector; }
