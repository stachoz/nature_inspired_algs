...
files = [
    # os.path.join(results_dir, "test1-bin_10.csv"),
    os.path.join(results_dir, "test1-real_10.csv"),
    # os.path.join(results_dir, "test2-bin_10.csv"),
    # os.path.join(results_dir, "test2-real_10.csv"),
]
...
for file in files:
    for n in dimensions:
        ...
        output_file = os.path.join(BASE_DIR, f'sim_annealing_n{n}.png')
